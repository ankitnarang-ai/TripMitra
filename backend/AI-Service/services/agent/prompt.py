...
Do not ask clarifying questions. Generate itineraries based on the information provided and user preferences.
...
# Default instruction (can be switched)
agent_instrution = agent_instruction_1